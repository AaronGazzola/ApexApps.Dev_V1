                                      ...
                                      <td class="column col-sm-12" width="600" style="width: 100%" align="left" valign="top">
                                        ...
                                        <div class="secondary-button button" style="background-color: #52FFBF; background-color: rgba(82,255,191,1); margin: 10px auto 25px;">
                                          <table role="presentation" width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              <td>
                                                <table role="presentation" width="auto" align="center" border="0" cellspacing="0" cellpadding="0" class="button__table" style="margin: 10px auto 25px;">
                                                  <tr>
                                                    <td align="center" class="button__cell" style="border-radius: 3px; padding: 6px 12px; background-color: #52FFBF; background-color: rgba(82,255,191,1);" bgcolor="rgba(82,255,191,1)"><a href="${actionLink}" class="button__link" style="color: #000000; text-decoration: none; background-color: #52FFBF; background-color: rgba(82,255,191,1); display: inline-block;
                                                    font-weight: 600;
                                                    "><span class="button__text" style="color: #000000;font-weight: 600; text-decoration: none;">
                        ${buttonText}
                      </span></a></td>
                                                  </tr>
                                                </table>
                                ...
                                <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                  <tr class="row__row">
                                    <td class="column col-sm-12" width="600" style="width: 100%" align="left" valign="top">
                                      ...
                                      <p class="content-text text p" style="font-weight: 100; display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; padding: 0 15px; color: #FFFFFF; font-size: 18px; margin: 0 0 5px;"> You just received a new call booking.</p>
                                ...
                                <div class="footer-row row" style="padding: 10px 25px;">
                                  <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                    <tr class="row__row">
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">This email was sent by Apex Apps, ABN: 81700757157.</p>
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">Make sure you add aaron@apexapps.dev to your address book and safe list.</p>
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">You have received this email because your email address was used to confirm a booking at ApexApps.dev. This is not a promotional email.</p>
                                      <p class="footer-text footer-center text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0; text-align: center;"><br/> &copy; Copyright ${moment().year()} Apex Apps</p>
                                      <p class="footer-text footer-center text p" large="4" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0; text-align: center;">Designed and developed by <a class="link a" href="${baseUrl}" style="color: #52FFBF; text-decoration: none;"><span class="a__text" style="color: #52FFBF; text-decoration: none;">Apex Apps</span></a></p>
                                    </tr>
                                  </table>
                                ...
                                <div class="footer-row row" style="padding: 10px 25px;">
                                  <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                    <tr class="row__row">
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">This email was sent by Apex Apps, ABN: 81700757157.</p>
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">Make sure you add aaron@apexapps.dev to your address book and safe list.</p>
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">You have received this email because your email address was used to cancel a booking at ApexApps.dev. This is not a promotional email.</p>
                                      <p class="footer-text footer-center text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0; text-align: center;"><br/> &copy; Copyright ${moment().year()} Apex Apps</p>
                                      <p class="footer-text footer-center text p" large="4" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0; text-align: center;">Designed and developed by <a class="link a" href="${baseUrl}" style="color: #52FFBF; text-decoration: none;"><span class="a__text" style="color: #52FFBF; text-decoration: none;">Apex Apps</span></a></p>
                                    </tr>
                                  </table>
                                ...
                                <div class="footer-row row" style="padding: 10px 25px;">
                                  <table class="row__table" width="100%" align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" style="table-layout: fixed;">
                                    <tr class="row__row">
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">This email was sent by Apex Apps, ABN: 81700757157.</p>
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">Make sure you add aaron@apexapps.dev to your address book and safe list.</p>
                                      <p class="footer-text text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0;">You have received this email because your email address was used to create a booking at ApexApps.dev. This is not a promotional email.</p>
                                      <p class="footer-text footer-center text p" large="2" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0; text-align: center;"><br/> &copy; Copyright ${moment().year()} Apex Apps</p>
                                      <p class="footer-text footer-center text p" large="4" style="display: block; line-height: 20px; font-family: Helvetica,Arial,sans-serif; color: #BDBDBD; font-size: 14px; padding: 0; margin: 0; text-align: center;">Designed and developed by <a class="link a" href="${baseUrl}" style="color: #52FFBF; text-decoration: none;"><span class="a__text" style="color: #52FFBF; text-decoration: none;">Apex Apps</span></a></p>
                                    </tr>
                                  </table>
