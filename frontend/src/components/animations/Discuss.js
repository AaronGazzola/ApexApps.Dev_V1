...
const Discuss = ({ animate }) => {
	...
	return (
		<svg
			...
			y='0px'
			viewBox='-4 -4 520 520'
			className={clsx(classes.svg, classes.discuss)}
		>
			<g>
				<g>
					<path
			...
			<g>
				<g>
					<path
						className={
							animate
								? clsx(classes.discuss6In, classes.orange)
								: played
								? clsx(classes.discuss6Out, classes.orange)
								: clsx(classes.discuss6Start, classes.orange)
						}
			...
			<g>
				<g>
					<path
						className={
							animate
								? clsx(classes.discuss7In, classes.orange)
								: played
								? clsx(classes.discuss7Out, classes.orange)
								: clsx(classes.discuss7Start, classes.orange)
						}
			...
			<g>
				<g>
					<path
						className={
							animate
								? clsx(classes.discuss8In, classes.orange)
								: played
								? clsx(classes.discuss8Out, classes.orange)
								: clsx(classes.discuss8Start, classes.orange)
						}
